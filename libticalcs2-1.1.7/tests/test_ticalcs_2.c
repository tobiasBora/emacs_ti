...
1       return -1;
       ...
       // set calc
       calc = ticalcs_handle_new(CALC_NSPIRE);
       if(calc == NULL)
       return -1;
...
*/
     ...
     // Cf : http://tiplanet.org/forum/viewtopic.php?f=19&t=10470&start=10
     printf("#################################################\n");
     ...
     else
     {
	  ...
	  // ########## Partie de tests :
	  /* is_ready(calc_handle); */
	  // ########## Partie de l'envoie du fichier
...
/* Divers recherches :
   Format de cables :
   case CABLE_NUL: return Py_BuildValue("s", "NULL");
   case CABLE_GRY: return Py_BuildValue("s", "GrayLink");
   case CABLE_BLK: return Py_BuildValue("s", "BlackLink");
   case CABLE_PAR: return Py_BuildValue("s", "ParallelLink");
   case CABLE_SLV: return Py_BuildValue("s", "SilverLink");
